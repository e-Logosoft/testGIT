...
/**
 * TlmUnitContact Entity
 * 
 * Generated by Dunamis App Generator
 */

@Entity
@Table(name = "TlmUnitContact")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "ELogoSoftRest/com/eLogoSoft/cwrv/domain", name = "TlmUnitContact")
public class TlmUnitContact implements Serializable {
    ...
    public void setDailyProgress(Boolean dailyProgress) {
    ...
    public boolean equals(Object obj) {
        if (obj == this)
            return true;
        if (!(obj instanceof TlmUnitContact))
            return false;
        TlmUnitContact equalCheck = (TlmUnitContact) obj;
